...
This repository contains the code of the [Angular Testing Course](https://angular-university.io/course/angular-tests-demo).
...
We can install the master branch using the following commands:
    ...
    git clone https://github.com/angular-university/angular-tests-demo.git
    
This repository is made of several separate npm modules, that are installable separately. For example, to run the au-input module, we can do the following:
    
    cd angular-tests-demo
    npm install
